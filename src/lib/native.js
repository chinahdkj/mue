...
const fns = [
    ...
    "bluetooth", "btDisConnected", "manualPost", "btGetParams"，"manualPostRes"
];

const fns2 = ['search', 'collect', 'btDisConnected', 'btReceiver', 'btGetParams'，'manualPostRes'] // 原生主动调用js的方法
